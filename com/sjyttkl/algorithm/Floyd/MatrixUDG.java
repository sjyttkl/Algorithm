package com.sjyttkl.algorithm.Floyd;

/**
 * Java: Floyd算法获取最短路径(邻接矩阵)
 * 它获得从某一个顶点到其余各个顶点的最短路径
 * @author xiaodong
 * @date 2017/07/17
 */
...
public class MatrixUDG
{
	...
	public void floyd(int[][] path, int[][] dist)
	{
		...
		// 计算最短路径
		for (int k = 0; k < mVexs.length; k++)//一共有多少个顶点
		{
			for (int i = 0; i < mVexs.length; i++)//行坐标
			{
				for (int j = 0; j < mVexs.length; j++)//纵坐标
				{
