...
/** 
 *https://github.com/sjyttkl/AVLTree
 * 平衡二叉树 
...
{  
     ...
     * 如果R的左子树的根节点的BF为-1或者为0时，先左旋然后再右旋 
     *  
     * 2.R为-2时，即右子树高于左子树： 
    ...
    {  
        boolean heightLower = true;   //检查旋转后，树的高度是否发生变化->是否变小了
        Entry<E> l = t.left;  
        switch (l.balance) 
        {  
